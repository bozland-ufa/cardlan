...
//This is the path of the voice device node, which can be modified according to its own node location.
...
//you don't have to know about the follow strcutrue (use for internal)
