...
- Input Parameter :
		    ...
		    value:     value to be operated   4 bytes£¬Little-Endian£¬Low end at front(eg:100£¬0xe8 0x03 0x00 0x00)
			keymode:      Key authentication method£¬0x0a or 0x0b
			incordectype:      1:INC operation  0:DEC operation
                        transtype:  1:execute transfer operation  0: not execute transfer operation
...
*/
	...
	unsigned char CardINCorDEC(unsigned char SectorNo, unsigned char BlockNo,unsigned char BlockTrans, 
    unsigned char keymode,unsigned char *value,unsigned char *key,unsigned char incordectype,unsigned char transtype);
/*
*************************************************************************************************************
